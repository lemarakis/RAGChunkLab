...
def run_evaluation():
    ...
    # 1. Fetch all QA pairs (evaluation set)
    ...
    print(f"--- Evaluation: Page-Based Chunking ---")
    ...
    for qid, question, expected_page, q_emb in qa_rows:
        ...
        if found_at_rank > 0:
            ...
            # Optional: print(f"[X] {qid}: Not found in Top-5 (Expected page {expected_page})")
            pass
    ...
    if valid_questions > 0:
        ...
        print(" Strategy: Page-Based (1 Chunk = 1 Page)")
        print("="*45)
